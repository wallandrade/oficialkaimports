...
|------|--------|---------|-----------------|
| 2026-08-14 | GET/PUT `shipment-item-name` EnvioEcom exigem `hasGlobalAccess` | Nome genérico do create por loja | Board de rastreio continua visível ao seller-scoped |
