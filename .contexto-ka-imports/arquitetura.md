...
|------|--------|---------|-----------------|
| 2026-09-03 | `GET /api/admin/financial-summary` devolve `totalInsurancePaid` / `insuredOrdersCount` no mesmo De/Até do summary | Card Seguro pago no dashboard | Demais campos do summary iguais |
