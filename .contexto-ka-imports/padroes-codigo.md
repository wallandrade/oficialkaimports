...
|------|--------|---------|-----------------|
| 2026-08-18 | Anti-padrão: score 100% só por nome, ignorando CPF/CNPJ no OFX | `matchIdentityScore` se o doc do pedido estiver no NAME/MEMO | Parser/apply inalterados |
