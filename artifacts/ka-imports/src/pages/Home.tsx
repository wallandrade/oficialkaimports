...
import { Loader2, X, Filter, SlidersHorizontal, Search } from "lucide-react";
  ...
  return (
    <AppLayout>
      ...
      <section className="py-6 sm:py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full flex-1">
        ...
        {/* Mobile Filter Button & Active Search */}
        <div className="flex flex-col gap-3 mb-6 lg:mb-8">
          <div className="flex items-center justify-between lg:hidden">
             <h2 className="text-2xl font-bold flex items-center gap-2 text-foreground">Catálogo</h2>
             <Button onClick={() => setIsMobileFiltersOpen(true)} variant="outline" className="gap-2 rounded-xl h-10 border-border bg-white shadow-sm hover:border-primary/50 transition-colors">
        ...
        {isMobileFiltersOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-[85vw] max-w-[360px] h-full bg-background flex flex-col shadow-2xl rounded-l-3xl overflow-hidden"
            >
              <div className="flex items-center justify-between p-6 bg-card border-b border-border/50">
                ...
                <button onClick={() => setIsMobileFiltersOpen(false)} className="p-2.5 bg-muted rounded-full text-foreground hover:bg-muted/80 transition-colors">
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="p-6 border-t border-border/50 bg-card">
                <Button className="w-full rounded-2xl h-14 text-base font-bold shadow-lg shadow-primary/20" onClick={() => setIsMobileFiltersOpen(false)}>
