...
const PUBLIC_KEYS  = [
  ...
  "checkout_insurance_enabled", "checkout_insurance_full_enabled", "checkout_insurance_reduced_enabled",
  "checkout_insurance_percent", "checkout_insurance_reduced_percent", "checkout_insurance_keep_percent",
