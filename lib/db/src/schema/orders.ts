...
export const ordersTable = mysqlTable("orders", {
  ...
  insuranceKeepAmount: decimal("insurance_keep_amount", { precision: 10, scale: 2 }).notNull().default("0.00"),
  insuranceCashbackAmount: decimal("insurance_cashback_amount", { precision: 10, scale: 2 }).notNull().default("0.00"),
  insuranceClaimStatus: varchar("insurance_claim_status", { length: 32 }).notNull().default("none"),
